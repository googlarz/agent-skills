...
Invoke the agent-skills:shipping-and-launch skill. For production service/runtime changes also invoke agent-skills:observability-and-monitoring (skip for libraries, CLIs, docs-only, config-only).
